...
INSERT INTO `auth_group` VALUES (7,'Administrador'),(5,'Agricultor'),(6,'EnteGubernamental');
...
INSERT INTO `auth_group_permissions` VALUES (17,5,61),(18,5,62),(19,5,63),(20,5,64),(21,6,65),(22,6,66),(23,6,67),(24,6,68),(25,7,69),(26,7,70),(27,7,71),(28,7,72);
...
INSERT INTO `django_admin_log` VALUES (63,'2022-05-17 19:28:02.364631','5','Agricultor',1,'[{\"added\": {}}]',11,6),(64,'2022-05-17 19:37:13.291752','7','López Martín, Alejandro',1,'[{\"added\": {}}]',10,6),(65,'2022-05-17 19:38:13.313166','7','López Martín, Alejandro',2,'[{\"changed\": {\"fields\": [\"Is staff\"]}}]',10,6),(66,'2022-05-17 19:39:05.666845','6','Administrador, Administrador',2,'[{\"changed\": {\"fields\": [\"Apellidos\"]}}]',10,6),(67,'2022-05-17 19:39:36.577112','7','López Martín, Alejandro',2,'[{\"changed\": {\"fields\": [\"Password\"]}}]',10,6),(68,'2022-05-17 19:40:22.583627','7','López Martín, Alejandro',3,'',10,6),(69,'2022-05-17 19:44:10.475820','8','López Martín, Alejandro',2,'[{\"changed\": {\"fields\": [\"Apellidos\"]}}]',10,6),(70,'2022-05-17 19:45:32.263056','8','López Martín, Alejandro',2,'[{\"changed\": {\"fields\": [\"Nombre de usuario\"]}}]',10,6),(71,'2022-05-17 19:47:04.916384','6','Ente Gubernamental',1,'[{\"added\": {}}]',11,6),(72,'2022-05-17 19:47:14.196777','6','EnteGubernamental',2,'[{\"changed\": {\"fields\": [\"Rol\"]}}]',11,6),(73,'2022-05-17 19:47:21.904215','7','Administrador',1,'[{\"added\": {}}]',11,6),(74,'2022-05-17 19:56:19.211543','8','López Martín, Alejandro',2,'[{\"changed\": {\"fields\": [\"Rol\"]}}]',10,6),(75,'2022-05-20 13:26:14.513420','6','Administrador, Administrador',2,'[{\"changed\": {\"fields\": [\"Rol\"]}}]',10,6),(76,'2022-05-20 14:50:17.458977','1','Config object (1)',1,'[{\"added\": {}}]',12,6),(77,'2022-05-20 14:53:08.122730','1','historico_min_date: 30 meses',2,'[{\"changed\": {\"fields\": [\"Unidad\"]}}]',12,6),(78,'2022-05-20 14:53:11.636330','1','historico_min_date: 30 días',2,'[{\"changed\": {\"fields\": [\"Unidad\"]}}]',12,6),(79,'2022-05-20 15:16:54.103643','1','historico_min_date: 30 dias',2,'[{\"changed\": {\"fields\": [\"Unidad\"]}}]',12,6),(80,'2022-05-20 15:23:33.831394','1','historico_min_date: 30 meses',2,'[{\"changed\": {\"fields\": [\"Unidad\"]}}]',12,6),(81,'2022-05-20 15:28:56.049859','1','historico_min_date: 30 meses',2,'[]',12,6),(82,'2022-05-20 15:29:06.898215','2','historico_max_date: 100 annos',1,'[{\"added\": {}}]',12,6),(83,'2022-05-20 15:31:17.142424','1','historico_min_date: 30 dias',2,'[{\"changed\": {\"fields\": [\"Unidad\"]}}]',12,6);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(9,'Estacion','datoscalamaca'),(7,'Estacion','estacion'),(8,'Estacion','estacioncoordenadas'),(6,'sessions','session'),(11,'Usuarios','rol'),(10,'Usuarios','usuario'),(12,'WebApp','config');
...
INSERT INTO `usuarios_rol` VALUES (7,'Administrador'),(5,'Agricultor'),(6,'EnteGubernamental');
...
INSERT INTO `usuarios_usuario` VALUES (6,'pbkdf2_sha256$320000$5xSEKO7DKKyHBvl3yfIeJI$H3oH//dlX17bFmz3b7XEZjcHyG8De/NlFrB6+/DU04I=','2022-05-22 17:37:25.786846','admin','admin@admin.com','Administrador','Administrador','',1,1,7,1),(8,'pbkdf2_sha256$320000$T97IZJFv8KQbu7Mwiy4vQd$g/KA3DM7lfXt356WS2KrKGANrO6QaV2x5jrzjgl7eG0=','2022-05-22 17:36:43.852278','alexlm','alexlopezmartin2001@yahoo.es','Alejandro','López Martín','',1,0,5,0);
...
--
-- Dumping data for table `webapp_config`
--

LOCK TABLES `webapp_config` WRITE;
/*!40000 ALTER TABLE `webapp_config` DISABLE KEYS */;
INSERT INTO `webapp_config` VALUES (1,'historico_min_date','30','dias'),(2,'historico_max_date','100','annos');
/*!40000 ALTER TABLE `webapp_config` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-22 20:04:14
